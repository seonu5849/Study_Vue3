...
export default {
	...
	setup() {
		...
		// 	/*
		// 		inputRef.value는 <input type="text"> 를 가져오고, document.querySelector('#input')와 동일
		// 		inputRef.value.value는 해당 input의 value값(=hello world!)을 가져온다. document.querySelector('#input').textContent와 동일
		// 	*/
